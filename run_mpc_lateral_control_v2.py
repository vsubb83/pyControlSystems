...
plt.plot(X_ref,statesTotal[:,3],'--r',linewidth=2,label='Rover position')
...
plt.plot(t,statesTotal[:,1],'--r',linewidth=2,label='Rover yaw angle')
plt.xlabel('t-time [s]',fontsize=12)
...
plt.plot(t,statesTotal[:,3],'--r',linewidth=2,label='Rover Y position')
plt.xlabel('t-time [s]',fontsize=12)
